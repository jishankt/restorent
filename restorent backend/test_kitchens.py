from app1 import get_data_scope_filter, app, kitchens_collection
...
can_access, filter_query = get_data_scope_filter('add_kitchen')
print("Count:", len(list(kitchens_collection.find(filter_query))))
