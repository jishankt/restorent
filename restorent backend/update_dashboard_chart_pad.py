...
def admin_dashboard_chart_data():
    try:
        ...
        # Seed default zeroes to make the line chart continuous and look like a stock chart
    ...
    if pattern.search(content):
        ...
        with open(target_file, "w", encoding="utf-8") as f:
            f.write(new_content)
        print("Updated chart data API successfully with padded zeroes.")
    else:
